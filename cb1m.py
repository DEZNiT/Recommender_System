...
item_cols = ['movieID', 'movie_title', 'genre']
#user_cols = ['userID', 'age', 'gender', 'occupation', 'zip_code']

# importing the data files onto dataframes
data = pd.read_csv('./ml-latest/ratings.csv', sep='\t', names=data_cols, encoding='latin-1')
item = pd.read_csv('./ml-latest/movies.csv', sep='|', names=item_cols, encoding='latin-1')
#users = pd.read_csv('./ml-latest/u.user', sep='|', names=user_cols, encoding='latin-1')
